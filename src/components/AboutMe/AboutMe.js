      ...
      <div className='section-about u-margin-bottom-medium'>
        ...
        <div className='about__textbox'>
          ...
          <p className='paragraph u-margin-top-medium'>
            ...
            <br />I’ve been working primarily in the ReactJS ecosystem which I really enjoy, but I’m always interested in adding more tech and tools to my tool belt. I have proven experience working both collaboratively and independently to deliver quality results. I'd love to chat if you have a full-time opportunity that you think I could be a good fit for!<br />
          </p>
