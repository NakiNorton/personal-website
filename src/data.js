  ...
  projects:[
    {
      ...
      techStack: ['React (w/ Hooks), React Router', 'JSON Web Token (JWT)', 'Fetch API', 'PWA', 'Redux', 'SASS/SCSS', 'Material UI', 'Continuous Integration(Travis CI)', 'Jest', 'React Testing Library']
    },
    {
      id: 2,
      name: 'Edible',
